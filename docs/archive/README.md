...
Docs kept for reference but **no longer current**. Their live substance moved elsewhere; don't treat these as
the source of truth.

| Archived | Superseded by |
|---|---|
| `rig-review-issues.md` | the kanban — open items folded into [../backlog/todo/](../backlog/todo/); shipped history in git |
